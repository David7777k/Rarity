...
import im.rarity.utils.player.DamagePlayerUtil;
import im.rarity.utils.player.MoveUtils;
import im.rarity.utils.player.StrafeMovement;
...
@FunctionRegister(name = "TargetStrafe", type = Category.Movement, description = "51")
