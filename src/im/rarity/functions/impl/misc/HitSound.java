...
import im.rarity.events.AttackEvent;
...
@FunctionRegister(name = "HitSound", type = Category.Misc, description = "33")
public class HitSound extends Function {
    ...
    public void playSound(Entity e) {
        try {
            ...
            InputStream is = mc.getResourceManager().getResource(new ResourceLocation("rarity/sounds/" + sound.get() + ".wav")).getInputStream();
