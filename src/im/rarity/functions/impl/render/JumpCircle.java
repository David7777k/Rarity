...
@FunctionRegister(name = "JumpCircle", type = Category.Render, description = "11")
public class JumpCircle extends Function {
    ...
    private final ResourceLocation circle = new ResourceLocation("rarity/images/circle.png");
