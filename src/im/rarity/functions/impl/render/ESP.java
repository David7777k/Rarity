...
import im.rarity.functions.impl.combat.AntiBot;
import im.rarity.functions.settings.impl.BooleanSetting;
import im.rarity.functions.settings.impl.ColorSetting;
...
@FunctionRegister(name = "ESP", type = Category.Render, description = "67")
