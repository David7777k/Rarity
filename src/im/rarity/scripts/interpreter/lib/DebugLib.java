...
import im.rarity.scripts.interpreter.Lua;
import im.rarity.scripts.interpreter.LuaBoolean;
import im.rarity.scripts.interpreter.LuaClosure;
import im.rarity.scripts.interpreter.LuaError;
import im.rarity.scripts.interpreter.LuaFunction;
import im.rarity.scripts.interpreter.LuaNil;
import im.rarity.scripts.interpreter.LuaNumber;
import im.rarity.scripts.interpreter.LuaString;
import im.rarity.scripts.interpreter.LuaTable;
import im.rarity.scripts.interpreter.LuaThread;
import im.rarity.scripts.interpreter.LuaUserdata;
import im.rarity.scripts.interpreter.LuaValue;
import im.rarity.scripts.interpreter.Print;
import im.rarity.scripts.interpreter.Prototype;
...
public class DebugLib extends TwoArgFunction {
	...
	public static NameWhat getobjname(Prototype p, int lastpc, int reg) {
		...
		if (pc != -1) {
			...
			case Lua.OP_GETTABLE: {
		        ...
		        LuaString vn = (Lua.GET_OPCODE(i) == Lua.OP_GETTABLE)
	...
	static String kname(Prototype p, int pc, int c) {
		if (Lua.ISK(c)) {
			...
			NameWhat what = getobjname(p, pc, c);
