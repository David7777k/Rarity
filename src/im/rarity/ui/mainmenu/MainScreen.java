...
public class MainScreen extends Screen implements IMinecraft {
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double delta) {
        Rarity.getInstance().getAltWidget().updateScroll((int) mouseX, (int) mouseY, (float) delta);
    ...
    public boolean charTyped(char codePoint, int modifiers) {
        Rarity.getInstance().getAltWidget().onChar(codePoint);
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        Rarity.getInstance().getAltWidget().click(fixed.getX(), fixed.getY(), button);
