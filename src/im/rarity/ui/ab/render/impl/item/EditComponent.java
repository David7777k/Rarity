package im.rarity.ui.ab.render.impl.item;

import com.mojang.blaze3d.matrix.MatrixStack;
import im.rarity.Rarity;
import im.rarity.ui.ab.render.impl.AddedItemComponent;
import im.rarity.ui.ab.render.impl.AllItemComponent;
import im.rarity.ui.ab.render.impl.Component;
import im.rarity.utils.client.IMinecraft;
import im.rarity.utils.components.ButtonComponent;
import im.rarity.utils.components.FieldComponent;
import im.rarity.utils.components.SliderComponent;
...
public class EditComponent extends Component implements IMinecraft {
    ...
    private final ButtonComponent add = new ButtonComponent(0, 0, 0, 0, "Добавить", () -> {
        if (!price.get().isEmpty()) {
            ...
            Rarity.getInstance().getItemStorage().addItem(stack.getItem(), Integer.parseInt(price.get()), Integer.parseInt(count.fieldComponent.get()), Integer.parseInt(damage.fieldComponent.get()), enchantmentWidget.get());
