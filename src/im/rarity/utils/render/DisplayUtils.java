...
import im.rarity.utils.shader.ShaderUtil;
...
public class DisplayUtils implements IMinecraft {
    ...
    public static boolean drawButton(String призраки, float x, float y, float buttonWidth, float buttonHeight) {
        return false;
    }

    public static void drawSlider(MatrixStack stack, float sliderX, float v, float sliderWidth, float sliderHeight, float v1, int rgb) {
    }

    public static void drawTexturedQuad(MatrixStack matrixStack, float posX, float posY, int i, int i1) {
