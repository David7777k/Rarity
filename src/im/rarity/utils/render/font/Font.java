package im.rarity.utils.render.font;
...
public class Font implements IMinecraft {
    ...
    public void drawString(MatrixStack ms, String searchText, float v, float v1, int rgb, float fontSize) {
    }

    public void drawTextWithShadow(MatrixStack matrixStack, String text, float x, float y, int textColor, float size, float v) {
    }
