package im.rarity.command.impl.feature;

import im.rarity.command.*;
import im.rarity.command.impl.CommandException;
import im.rarity.config.Config;
...
public class ConfigCommand implements Command, CommandWithAdvice, MultiNamedCommand {
    ...
    public void execute(Parameters parameters) {
        ...
        switch (commandType) {
            ...
            case "clear" -> clearConfig();
            default ->
                    throw new CommandException(TextFormatting.RED + "Укажите тип команды:" + TextFormatting.GRAY + " load, save, list, dir, clear");
        }
    }
    ...
    public List<String> adviceMessage() {
        ...
        return List.of(commandPrefix + name() + " load <config> - Загрузить конфиг",
                ...
                commandPrefix + name() + " clear - Очистить все конфигурации",
    ...
    private void clearConfig() {
        configStorage.clearConfigurations();
        logger.log(TextFormatting.GREEN + "Все конфигурации были очищены!");
    }
}
