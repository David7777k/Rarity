...
import im.rarity.functions.impl.combat.NoEntityTrace;
import im.rarity.functions.impl.misc.BetterMinecraft;
import im.rarity.functions.impl.render.GlassHand;
...
public class GameRenderer implements IResourceManagerReloadListener, AutoCloseable {
    ...
    private void hurtCameraEffect(MatrixStack matrixStackIn, float partialTicks) {
        ...
        Rarity.getInstance().getEventBus().post(eventCancelOverlay);
