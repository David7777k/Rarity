...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = Rarity.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(Rarity.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        Rarity.getInstance().getViaMCP().viaScreen.tick();
