...
import im.rarity.events.*;
import im.rarity.functions.api.FunctionRegistry;
import im.rarity.functions.impl.misc.AntiPush;
import im.rarity.functions.impl.misc.SelfDestruct;
import im.rarity.functions.impl.movement.AutoSprint;
...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
    ...
    public void tick() {
        if (this.world.isBlockLoaded(new BlockPos(this.getPosX(), 0.0D, this.getPosZ()))) {
            if (!Rarity.getInstance().playerOnServer) {
                Rarity.getInstance().playerOnServer = true;
            }

            Rarity.getInstance().getEventBus().post(eventUpdate);
            super.tick();
    ...
    private void onUpdateWalkingPlayer() {
        ...
        Rarity.getInstance().getEventBus().post(ea);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            Rarity.getInstance().getEventBus().post(eventMotion);
        ...
        Rarity.getInstance().getEventBus().post(new EventPostMotion());
    ...
    public void sendChatMessage(String message) {
        ...
        CommandDispatcher commandDispatcher = Rarity.getInstance().getCommandDispatcher();
    ...
    public void closeScreen() {
        ...
        Rarity.getInstance().getEventBus().post(event);
        if (!event.isCancel()) {
    ...
    public void setSprinting(boolean sprinting) {
        Rarity.getInstance().getEventBus().post(sprintEvent);
    ...
    public void livingTick() {
        ...
        if (this.isHandActive() && !this.isPassenger()) {
            Rarity.getInstance().getEventBus().post(noSlowEvent);
