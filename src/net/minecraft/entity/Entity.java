...
import im.rarity.events.EventStartRiding;
import im.rarity.events.MovingEvent;
import im.rarity.events.PostMoveEvent;
import im.rarity.functions.api.FunctionRegistry;
import im.rarity.functions.impl.combat.Hitbox;
import im.rarity.functions.impl.render.Trails;
import im.rarity.scripts.lua.classes.EntityClass;
...
public abstract class Entity implements INameable, ICommandSource {
    ...
    public void move(MoverType typeIn, Vector3d pos) {
        ...
        if (this.noClip) {
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Rarity.getInstance().getEventBus().post(move);
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Rarity.getInstance().getEventBus().post(post);
            }
    ...
    public boolean startRiding(Entity entityIn, boolean force) {
        Rarity.getInstance().getEventBus().post(new EventStartRiding(entityIn));
