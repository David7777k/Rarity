...
import im.rarity.events.EventDamageReceive;
import im.rarity.events.JumpEvent;
import im.rarity.functions.api.FunctionRegistry;
import im.rarity.functions.impl.misc.AntiPush;
import im.rarity.functions.impl.render.SwingAnimation;
...
public abstract class LivingEntity extends Entity {
    ...
    public boolean onLivingFall(float distance, float damageMultiplier) {
        ...
        if (i > 0) {
            ...
            if (this instanceof ClientPlayerEntity) {
                Rarity.getInstance().getEventBus()
    ...
    protected void jump() {
        ...
        if (this instanceof ClientPlayerEntity entity) {
            Rarity.getInstance().getEventBus().post(jumpEvent);
        }
