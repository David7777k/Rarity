...
import im.rarity.events.EventCalculateCooldown;
import im.rarity.events.EventCooldown;
...
public class CooldownTracker {
    ...
    public float getCooldown(Item itemIn, float partialTicks) {
        ...
        Rarity.getInstance().getEventBus().post(cooldown);
        ...
        if (!this.cooldowns.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                if ((entry.getValue()).expireTicks <= this.ticks) {
                    ...
                    Rarity.getInstance().getEventBus().post(eventCooldown);
                    iterator.remove();
